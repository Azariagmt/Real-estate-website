                ...
                suggestion: function (suggestion) {
                    const markup = `
                        ...
                        <div class="algolia-details">
                            <span>${suggestion._highlightResult.bedrooms.value} <br> <img src="img/rooms/bed.png" alt=""> </span>
                            <span>${suggestion._highlightResult.bathrooms.value} <br> <img src="img/rooms/bath.png" alt=""></span>
                        </div>
                    `;
