...
class PropertiesController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $locationsForProperty = $property->categories()->get();


        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'allLocations','allTypes','allStatuses','categoriesForProduct'));
    }
