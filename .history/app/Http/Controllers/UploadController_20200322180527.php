...
public function uploadDocument(Request $request) {
    ...
    $email=$request->get('email');
        $total=$request->get('bedrooms');
        $bedrooms=$request->get('bedrooms');
        $bathrooms=$request->get('bedrooms');
        $parking=$request->get('bedrooms');
        $location=$request->get('bedrooms');
        $status=$request->get('bedrooms');
        $type=$request->get('bedrooms');
        $size=$request->get('bedrooms');
        $price=$request->get('bedrooms');
