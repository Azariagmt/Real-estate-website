...
@section('content')
<div class="row heightfull position-fixed .no-gutters">
	<div class="col-12 col-sm-12 col-md-12 col-lg-9 float:left container_flow">
   <div class="container">
...
<div class="container col-lg-3 col-md-3 col-sm-0 col-sx-0 position:fixed float-right border w-100 frc pdb stretch">
    @include('partials.frontcart')
</div>
</div>
@endsection
