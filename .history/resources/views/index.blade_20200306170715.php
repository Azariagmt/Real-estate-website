                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-12 align-items-end">
                                            <div class="form-group">
												...
												<input class="form-control mr-sm-6 search-box col-md-12" type="text" placeholder="Search the item you are looking for" value="{{ request()->input('query') }}" aria-label="Search" id="query" name="query">
