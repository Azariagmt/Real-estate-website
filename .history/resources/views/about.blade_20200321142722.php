...
<body>
	...
	<!-- Page top section -->
	<section class="page-top-section set-bg" data-setbg="{{$abouts->banner_image}}">
		<div class="container">
			<div class="row">
				<div class="col-lg-5">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="design-text">
						<h4>WORK REMOTE</h4>
						<p>  Praesent viverra non massa id condimentum. Morbi malesuada laoreet neque, id mattis neque ullamcorper eget. Vivamus aliquam tempus velit, sit amet scelerisque diam scelerisque ut. Donec venenatis dolor eu ante tincidunt varius. </p>
					</div>
				</div>
			</div>
		</div>
