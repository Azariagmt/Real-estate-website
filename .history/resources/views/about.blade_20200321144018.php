			...
			<div class="row">
				<div class="col-lg-5">
					<div class="page-top-text text-white">
						<h2>About Us</h2>
						<p>{{optional($aboutsNoCollection)->banner_description}}</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="about-text">
						<h4>{{optional($aboutsNoCollection)->detail_title}}</h4>
						<p>{{optional($aboutsNoCollection)->detail_description}}</p>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="about-slider owl-carousel">
						<img src="{{optional($aboutsNoCollection)->slider_image_1}}" alt="">
						<img src="{{optional($aboutsNoCollection)->slider_image_2}}" alt="">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="design-text">
						<h4>JOIN OUR TEAM </h4>
						<p>{{optional($aboutsNoCollection)->join_our_team}} </p>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="design-text">
						<h4>WORK REMOTE</h4>
						<p>  {{optional($aboutsNoCollection)->work_remote}} </p>
					</div>
				</div>
			</div>
		</div>
