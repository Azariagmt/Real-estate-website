<nav class="navbar navbar-expand-lg navbar-light bg-none fixed-top mx-auto" >
  ...
  <div class="collapse navbar-collapse mx-auto" id="navbarSupportedContent">
    <ul class="navbar-nav mx-auto row .d-none .d-lg-block">
...
<!--                    -->@endforeach
      ...
      <li class="nav-item dropdown border col-md-2 col-lg-2" >
        <a class="nav-link dropdown-toggle mx-aut" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Location
        </a>
      ...
      <li class="col-md-1 col-lg-2">
      <a href="{{route('property')}}" style="font-size:12px;  font-weight:bold; background-color:#cfd8dc;">View all <br>Properties</a>
      </li>
      <div class="form-inline my-lg-0 mx-auto aa-input-container col-md-6 col-lg-4 "  id="aa-input-container" >
