...
<!--                    -->@endforeach
      ...
      <li class="nav-item dropdown border col-md-12 col-lg-2 col-xl-3">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
           Status
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
      ...
      <li class="col-md-12 col-lg-2 col-xl-1">
      <a href="{{route('property')}}" style="font-size:12px;  font-weight:bold; background-color:#cfd8dc;">View all <br>Properties</a>
      </li>
      <div class="form-inline my-lg-0 mx-auto aa-input-container col-md-12 col-lg-4 col-xl-2"  id="aa-input-container" >
