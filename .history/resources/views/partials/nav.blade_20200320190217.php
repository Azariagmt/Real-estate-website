...
<!--                    -->@endforeach
      ...
      <div class="form-inline my-lg-0 mx-auto "  id="aa-input-container">
          <input type="search" id="aa-search-input" class="form-control mr-sm-6 search-box col-md-12" aria-label="Search"  placeholder="Search for products" name="search"
          autocomplete="off" />
          <button class=" text-white btn btn-raise btn-success my-2 my-sm-0" type="submit"><i class="fa fa-search"></i></button>
      </div>
            </ul>
        </ul>
    </ul>
