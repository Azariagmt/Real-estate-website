<nav class="navbar navbar-expand-lg navbar-light bg-none fixed-top mx-auto" >
    <a href="{{route('landing-page')}}" class="site-logo navbar-brand" style="margin-left:30px;">
			<img src="{{asset('img/yenebet-logo.png')}}" alt="" class="img-fluid" width="60px">
		</a>
...
<!--                    -->@endforeach
            ...
            <div class="col-md-6 float-left">
             <div class="row float-right" >
                <div class="" >
                      <a class="nav-link text-white btn-outline-primary mx-auto float-right border" style="font-weight:bold;" href="{{route('multiuploads')}}"><i class="fa fa-sale" aria-hidden="true"></i> Selling a property?</a>
                </div>
