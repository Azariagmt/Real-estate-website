...
<!--                    -->@endforeach
      ...
      <div class="form-inline my-lg-0 mx-auto "  id="aa-input-container" class="aa-input-container">
          <input type="search" id="aa-search-input" class="form-control mr-sm-6 search-box" aria-label="Search"  placeholder="Search for properties" name="search"
          autocomplete="off" />
