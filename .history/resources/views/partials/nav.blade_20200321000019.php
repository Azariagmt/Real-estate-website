<nav class="navbar navbar-expand-lg navbar-light bg-none fixed-top mx-auto" >
  ...
  <div class="collapse navbar-collapse row mx-auto" id="navbarSupportedContent">
    <ul class="navbar-nav mx-auto col-lg-12 .d-none .d-md-bl.d-lg-block">
...
<!--                    -->@endforeach
      ...
      <div class="form-inline my-lg-0 mx-auto aa-input-container col-md-12 col-lg-4 "  id="aa-input-container" >
