            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="row ">
                   ...
                   <div class="" >
                      <a href="tel:+{{$s->phone1}}" class="nav-link text-white">         <i class=" text-white fa fa-s"></i> +{{$s->phone1}}</a>
                              </div>
                          
                              <div class="" >
                      <a href="tel:+{{$s->phone2}}" class="nav-link text-white">         <i class=" text-white fa fa-s"></i> +{{$s->phone2}}</a>
                              </div>
<!--                    -->
                </div>
              </div>
