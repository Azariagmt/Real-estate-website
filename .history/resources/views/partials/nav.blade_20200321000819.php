...
<!--                    -->@endforeach
      ...
      <li class="col-md-12 col-lg-2 col-xl-2">
      ...
      <div class="form-inline my-lg-0 mx-auto aa-input-container col-md-12 col-lg-4 col-xl-3"  id="aa-input-container" >
          <input type="search" style=""id="aa-search-input" class="aa-input-search " aria-label="Search"  placeholder="Search for properties" name="search"
          autocomplete="off" />
