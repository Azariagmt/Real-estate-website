<nav class="navbar navbar-expand-lg navbar-light bg-primary  mx-auto sticky-top">
        ...
        <ul style="list-style:none;">
            ...
            <div class="row">
                ...
                <div class="row">
                        ...
                        <a class="nav-link text-white" href="#"><i class="fa fa-phone" aria-hidden="true"></i>  +251 91 697 186</a>
            </div>
            </div>
           </div>
            </li>
            
                <ul class="navbar-nav  main-menu border" style="background-color:grey;">
