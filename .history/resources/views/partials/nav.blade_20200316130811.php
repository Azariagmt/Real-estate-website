<nav class="navbar navbar-expand-lg navbar-light bg-success  mx-auto sticky-top">
    ...
    <ul class="navbar-nav mx-auto">
        <ul style="list-style:none;">
           ...
           <div class="row float-right">
                <div class="" >
                        <a class="nav-link text-white" href="#"><i class="fa fa-phone" aria-hidden="true"></i> Login</a>
                </div>
                <div class="float-right">
                    <div class="row">
