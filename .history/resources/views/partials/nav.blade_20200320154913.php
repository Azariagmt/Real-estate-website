            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="row ">
                   ...
                   <div class="" >
                      <a href="tel:+{{$phones->phone1}}" class="nav-link text-white">         <i class=" text-white fa fa-phones"></i> +{{$phones->phone1}}</a>
                              </div>
                          
                              <div class="" >
                      <a href="tel:+{{$phones->phone2}}" class="nav-link text-white">         <i class=" text-white fa fa-phones"></i> +{{$phones->phone2}}</a>
                              </div>
<!--                    -->
                </div>
              </div>
      ...
      <button class="btn btn-raised btn-info my-2 my-sm-0" type="submit"><i class="fa fa-search"></i></button>
    </form>
            </ul>
        </ul>
    </ul>
