            ...
            <div class="row">
              ...
              <div class="col-md-6 float-left">
               <div class="row float-right" >
                  <div class="" >
                          <a class="nav-link text-white btn-outline-secondary mx-auto float-right border" style="font-weight:bold;" href="#"><i class="fa fa-sale" aria-hidden="true"></i> Selling a property?</a>
                  </div>
