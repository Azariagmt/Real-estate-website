...
<!--                    -->@endforeach
      ...
      <li class="nav-item dropdown border col-md-2 col-lg-2">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
         @foreach($type as $type)
          <a class="dropdown-item {{request()->type == $type->slug?'active':''}}" href="{{route('', ['type'=>$type->slug])}}">{{$type->name}}</a>
         @endforeach
        </div>
      </li>
      <li class="nav-item dropdown border col-md-2 col-lg-2">
      ...
      <div class="form-inline my-lg-0 mx-auto aa-input-container col-md-5 col-lg-3 "  id="aa-input-container" >
